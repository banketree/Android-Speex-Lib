...
public class SpeexWriteClient {
	private static final String Tag = SpeexWriteClient.class.getSimpleName();
	...
	private void init(String fileName) {
		...
		speexWriter = new OggSpeexWriter(mode, sampleRate, channels, nframes,
				vbr);
	...
	public void writeTag(byte[] buf, int size) {
		Log.d(Tag, "here should be:===========================640,actual="
				+ size);
		try {
